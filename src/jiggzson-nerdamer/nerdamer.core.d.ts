...
export declare function nerdamer(
...
export declare namespace nerdamer {
    export function addStepper(stepper: TStepper): void;
     ...
     */
    export function sum(expression: ExpressionParam, index: string, lower: ExpressionParam, upper: ExpressionParam): Expression;
