...
export const Scale = ({ index, animations, play }: { index: number; animations: any; play: boolean }) => {
        ...
        <div className="flex justify-between items-center mb-1">
            <div className="flex w-[40%] justify-between">
                ...
                <span className="flex pr-5">
                    ...
                    <input name="y" className="rounded-sm px-2 w-[80%] shadow-[0_1px_#cdd8dd]" value={scale.y} onChange={(e) => onChange(e)} disabled={play} />
                </span>
            </div>
